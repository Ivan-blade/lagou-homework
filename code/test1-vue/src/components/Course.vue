...
export default {
  ...
  methods: {
    ...
    getComment(){
      return this.axios
      .get("/api/course/comment/getCourseCommentList/"+this.course.id+"/1/20")
      .then((result) => {
    ...
    saveComment(){
       return this.axios
        .get("/api/course/comment/saveCourseComment",{
          params:{
            courseid:this.course.id,
    ...
    getMyCourseList(){ 
      return this.axios
      .get("/api/course/getCourseByUserId/"+this.user.content.id)
      .then((result) => {
        console.log(result);
    ...
    zan(comment){        
      return this.axios
      .get("/api/course/comment/saveFavorite/"+comment.id+"/"+this.user.content.id)
      .then((result) => {
        // console.log(result);
        // 重新获取本门课的全部留言信息
        this.getComment();
    ...
    cancelzan(comment){
      return this.axios
      .get("/api/course/comment/cancelFavorite/"+comment.id+"/"+this.user.content.id)
      .then((result) => {
        // console.log(result);
        // 重新获取本门课的全部留言信息
        this.getComment();
