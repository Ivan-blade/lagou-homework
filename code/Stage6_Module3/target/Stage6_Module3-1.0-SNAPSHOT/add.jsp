        ...
        <div class="col-lg-6">
            <form action="${pageContext.request.contextPath}/employee/save" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="dept_id" name="dept_id" placeholder="请输入部门id">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="join_date" name="join_date" placeholder="请输入入职日期">
                </div>
                <div class="form-group">
