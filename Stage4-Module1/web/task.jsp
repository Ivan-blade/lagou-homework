...
<body>
    <div>
        ...
        %>
        <h2 style="width: 30%; margin: 0 auto;">登录成功，欢迎<%= ((User)session.getAttribute("user")).getUserName() %>使用！</h2>
        <%
            }
        %>
    </div>
    <div class="flex-row first">
        ...
        <form action="/task03_demo03/studentSelectAll" method="get" style="margin-right: 20px;">
            <input class="btn btn-primary" type="submit" value="查询全部">
        </form>
        <form action="/task03_demo03/studentSelectById" method="get" style="margin-right: 20px;">
            <input class="btn btn-primary" type="submit" value="查询">
            <input style="margin-left: 5px;" type="text" name="id" placeholder="按id查询" required>
        </form>
        <form action="/task03_demo03/studentDelete" method="get">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/task03_demo03/studentInsert" method="post">
